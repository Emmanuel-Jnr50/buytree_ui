...
const Navbar = () => {
  return (
    <nav className="font-family flex items-center justify-between py-6 px-25 max-xl:px-15 max-lg:px-10 max-md:px-5 fixed top-0 left-0 right-0 bg-white z-50">
        ...
        <div className="right-nav flex space-x-20 items-center max-[1440px]:space-x-8 max-lg:space-x-6">
            ...
            <div className="flex items-center space-x-6">
                <button className='font-medium flex space-x-4 items-center border border-[#d6d6d6] px-4 py-2 rounded-xl gap-1.5 shadow-default hover:shadow-hover duration-400 cursor-pointer max-md:hidden max-sm:hidden'>Get Started<ArrowRight /></button>
